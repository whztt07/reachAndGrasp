...
void HDRListener::notifyMaterialSetup(Ogre::uint32 pass_id, Ogre::MaterialPtr &mat)
{
    ...
    std::cout << "\nmBloomTexOffsetsHorzX\n";
    for(int i=0;i<15;i++)
    {
        std::cout << mBloomTexOffsetsHorz[i][0] << "\t";
    }
    std::cout << "\nmBloomTexOffsetsHorzY\n";
    for(int i=0;i<15;i++)
    {
        std::cout << mBloomTexOffsetsHorz[i][1] << "\t";
    }
    std::cout << "\nmBloomTexOffsetsVertX\n";
    for(int i=0;i<15;i++)
    {
        std::cout << mBloomTexOffsetsVert[i][0] << "\t";
    }
    std::cout << "\nmBloomTexOffsetsVertY\n";
    for(int i=0;i<15;i++)
    {
        std::cout << mBloomTexOffsetsVert[i][1] << "\t";
    }
    
    std::cout << "\nmBloomTexWeights\n";
    for(int i=0;i<15;i++)
    {
        std::cout << mBloomTexWeights[i][0] << "\t";
    }
}
//---------------------------------------------------------------------------
