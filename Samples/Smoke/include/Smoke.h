...
protected:
    ...
    {     
        ...
        headNode->attachObject(mSceneMgr->createParticleSystem("Aureola", "Examples/Aureola"));
        headNode->attachObject(mSceneMgr->createParticleSystem("Explosion", "Examples/Explosion"));
